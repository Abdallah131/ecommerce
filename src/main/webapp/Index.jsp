...
<body>
	...
	<nav>
		<div class="navtop">
			...
			<div class="navitem">
				<div class="search" style="position: absolute; top: 2.5%;">
			...
			<div class="navitem" style="padding-top: 15px;">
				<a href="Register.jsp" style="text-decoration: none;"> <span
					class="Welcome">Register</span>
				</a> <span class="Welcomebar">|</span> <a href="Login.jsp"
					style="text-decoration: none;"> <span class="Welcome">Login</span>
				</a>
			</div>
		</div>
		<div class="navbottom">
